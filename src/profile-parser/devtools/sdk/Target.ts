import {Connection, TargetBase} from "../core/InspectorBackend";
import {SDKModel} from "./SDKModel";
import {Target as ProtoTarget} from "../generated/protocol";
import TargetID = ProtoTarget.TargetID;
import TargetInfo = ProtoTarget.TargetInfo;
...
export class Target extends TargetBase {
    ...
    #idInternal: TargetID|'main';
    #modelByConstructor: Map<new(arg1: Target) => SDKModel, SDKModel>;
    #isSuspended: boolean;
    #targetInfoInternal: TargetInfo|undefined;
    #creatingModels?: boolean;

    constructor(
        // targetManager: TargetManager,
        id: TargetID|'main', name: string, type: Type,
    ...
    // targetManagerger(): TargetManager {
