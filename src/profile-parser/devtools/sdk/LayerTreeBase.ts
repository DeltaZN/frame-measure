...
import type {DOMNode} from './DOMModel';
...
export class StickyPositionConstraint {
  readonly #stickyBoxRectInternal: DOM.Rect;
  readonly #containingBlockRectInternal: DOM.Rect;
  readonly #nearestLayerShiftingStickyBoxInternal: Layer|null;
  readonly #nearestLayerShiftingContainingBlockInternal: Layer|null;

  constructor(layerTree: LayerTreeBase|null, constraint: LayerTree.StickyPositionConstraint) {
...
export class LayerTreeBase {
  ...
  readonly #backendNodeIdToNodeInternal: Map<DOM.BackendNodeId, DOMNode|null>;
  ...
  async resolveBackendNodeIds(requestedNodeIds: Set<DOM.BackendNodeId>): Promise<void> {
  ...
  backendNodeIdToNode(): Map<DOM.BackendNodeId, DOMNode|null> {
